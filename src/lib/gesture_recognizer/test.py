"""
    ...
    **Public Methods**:
        ...
        *add_gesture* --> adds new gesture to sample

        *remove_gesture* --> removes gesture from sample
...
# initialize lib
from src.lib.gesture_recognizer.hand_detector import HandDetector
from src.lib.gesture_recognizer.model_trainer import ModelTrainer
from src.lib.gesture_recognizer.gesture_recognizer import GestureRecognizer

# initialize utils_deprecated
from src.utils_deprecated.video_capture import VideoCapture
from src.utils_deprecated.cleanup import Cleanup
from src.utils_deprecated.logger import Logger

# paths
path_to_models = os.path.abspath('model')
path_to_datasets = os.path.abspath('sample')

#variables

# create utils_deprecated and lib
VideoCapture = VideoCapture()
Logger = Logger('gesture_recognizer')
...
class GesturesController:
    ...
    def add_gesture(self, name: str):
        ...
        # create new 'directory' in 'sample'
...
test = GesturesController(listen_to)
test.train_model()